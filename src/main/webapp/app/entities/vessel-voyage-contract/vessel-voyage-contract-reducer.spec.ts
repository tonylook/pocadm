...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './vessel-voyage-contract.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VESSELVOYAGECONTRACT_LIST actions', async () => {
    ...
    it('dispatches FETCH_VESSELVOYAGECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VESSELVOYAGECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VESSELVOYAGECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VESSELVOYAGECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VESSELVOYAGECONTRACT actions', async () => {
      const expectedActions = [
        {
