  ...
  return (
    <div>
      <h2 id="sale-contract-heading" data-cy="SaleContractHeading">
        <Translate contentKey="pocadmApp.saleContract.home.title">Sale Contracts</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="pocadmApp.saleContract.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="pocadmApp.saleContract.home.createLabel">Create new Sale Contract</Translate>
          </Link>
        </div>
      </h2>
        ...
        {saleContractList && saleContractList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="pocadmApp.saleContract.id">ID</Translate>
                </th>
                <th>
            ...
            <tbody>
              {saleContractList.map((saleContract, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`pocadmApp.Quality.${saleContract.soymealQuality}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="pocadmApp.saleContract.home.notFound">No Sale Contracts found</Translate>
            </div>
          )
        )}
      </div>
