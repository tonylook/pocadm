...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './purchase-contract.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PURCHASECONTRACT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PURCHASECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PURCHASECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PURCHASECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PURCHASECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PURCHASECONTRACT actions', async () => {
      const expectedActions = [
        {
