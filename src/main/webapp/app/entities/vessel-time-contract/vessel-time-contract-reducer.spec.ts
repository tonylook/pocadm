...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './vessel-time-contract.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VESSELTIMECONTRACT_LIST actions', async () => {
    ...
    it('dispatches FETCH_VESSELTIMECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VESSELTIMECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VESSELTIMECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VESSELTIMECONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VESSELTIMECONTRACT actions', async () => {
      const expectedActions = [
        {
